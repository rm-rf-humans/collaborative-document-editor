...
Full Mermaid source listings for Figures~\ref{fig:system-context} to~\ref{fig:backend-components}, plus the data model diagram, are provided in Appendix~\ref{app:mermaid}.
...
\begin{figure}[H]
    ...
    \caption{Entity-relationship diagram for the target data model.}
